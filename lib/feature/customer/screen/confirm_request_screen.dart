// lib/features/home/views/confirm_request_screen.dart
...
class _ConfirmRequestScreenState extends State<ConfirmRequestScreen> {
  ...
  Future<void> _submitRequest() async {
    print('[SEND OFFER] Button tapped — requestId: \$_requestId');
    setState(() => _isSending = true);
    try {
      print('[SEND OFFER] Calling: \${ApiEndpoint.sendOffer(_requestId)}');
      final response = await _apiClient.post(
        ApiEndpoint.sendOffer(_requestId),
        body: {},
      );
      print('[SEND OFFER] Response: \$response');
      print('[SEND OFFER] Navigating to: \${RouteName.review}');
      if (mounted) {
        Get.toNamed(RouteName.review);
        print('[SEND OFFER] Navigation called');
      }
    } on HttpException catch (e) {
      print('[SEND OFFER] HttpException: \${e.message} | statusCode: \${e.statusCode}');
      Get.snackbar('Error', e.message);
    } catch (e, stack) {
      print('[SEND OFFER] Unknown error: \$e');
      print('[SEND OFFER] Stack: \$stack');
